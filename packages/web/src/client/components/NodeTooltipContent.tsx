...
function extractTooltipText(children: React.ReactNode): string {
    ...
    if (Array.isArray(children)) return children.map((c) => extractTooltipText(c) ?? '').join('')
    if (children && typeof children === 'object' && 'props' in children) {
        return extractTooltipText((children as { props: { children?: React.ReactNode } }).props.children)
    }
    return ''
}
