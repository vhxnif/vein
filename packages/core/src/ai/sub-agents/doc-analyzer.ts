...
- [docId:nodeId] 章节标题（例如：- [a1b2c3d4e5f6a1b2:0001] 项目背景）
  其中 docId 为当前分析文档的完整文档ID
- [docId:nodeId] 章节标题
...
- 详细分析中必须使用 **[docId:nodeId]** 格式（**必须带方括号**）标注所有引用
  正确：**[a1b2c3d4e5f6a1b2:0001]**  错误：a1b2c3d4e5f6a1b2:0001
- 不要编造文档中不存在的内容`
